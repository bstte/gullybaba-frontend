...
export default function Sidebar() {
  ...
  const models = [
    ...
    { name: "WC Abandoned Carts", path: "/wc-abandoned-carts", icon: "M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.116 60.116 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM12 8.25v3.75l2.25 1.5" }
        ...
        {models.map((model) => {
          ...
          return (
            <Link
              key={model.name}
              href={model.path}
              className={`w-full flex items-center gap-3 px-3 py-2.5 rounded text-left text-xs font-medium transition-colors ${isActive
